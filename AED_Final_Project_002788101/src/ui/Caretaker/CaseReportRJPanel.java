...
public class CaseReportRJPanel extends javax.swing.JPanel {

    /**
     * Creates new form CaseReportRJPanel
     */
    ...
    Network network;
    public CaseReportRJPanel(JPanel userProcessContainer, EcoSystem system, CaseReporterWorkRequest request,UserAccount userAccount, Network network) {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnSendInvite.setBackground(new java.awt.Color(0, 102, 102));
    ...
    private void btnSendInviteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSendInviteActionPerformed
        ...
        try
        {
            ...
            msg.setSubject("A Caretaker has been assigned.");
